...
public class MaticeTerenu {
    ...
    public MaticeTerenu(String jmeno) {
        this.jmeno = jmeno;
        try {
            matice();
        } catch (IOException e) {
    ...
    /**
     * nacita data z binarniho souboru jako parametr bere vstupni argumet vraci nacteny soubor ulozeny do jednotlivych
     * promenych
     * 
     * @param jmeno
     *            jmeno(string) souboru ze ktereho se ma nacist
     * @throws IOException
     */

    public void matice() throws IOException {
    ...
    /**
     * kazdy prvek pole prepocita do rozsahu 0 - 1 * jako parametr bere pozici prvku v poli vraci hodnotu float 0 - 1
     *
     * @param i
     *            sloupec
     * @param j
