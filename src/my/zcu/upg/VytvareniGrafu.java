...
public class VytvareniGrafu {
	...
	/**
	 * prepocitava vzdalenost kterou strela uletela
	 * vytvari  pole naplnene hodnotami
	 * hodnody predstavuji vzdalenost od prvniho bodu
	 * 
	 ...
	 * 
	 * @param a index prvku ktery chci ziskat
	...
	/**
	 * vytvari xy souradnice grafu
	 * nacita osu Z (vysku v metrech) a tu uklada jako 'Y' souradnici
	 * 'X' souradnice je vzdalenost kterou strela uletela
	 * 
	...
	/**
	 * vytvari pole naplnene souradnicemi pro graf 
	 * vyjadrujici zavislost mezi pocatecni rychlosti na elevaci vyjadrujici
	...
	/**
	 * vytvari souradnice grafu
	 * nacita ze vstupniho souboru vysku terenu tu uklada jako 
	 * 'Y' souradnici
	 * 'X' souradnice je vzdalenost v metrech
	 * 
	...
	/**
	 * vytvari lineGraf podle souradnic
	 * kresli graf kde 
	 * prvni je strela a druhy je zeme pod ni(vyska zeme)
	 * 
	 * @return vraci graf
	 */
	...
	public JFreeChart strelaAZeme() {
		...
		ds.addSeries(zeme);
		ds.addSeries(strela);
		JFreeChart chart = ChartFactory.createXYLineChart("Vykresleni drahy letu strely nad zemi se zapoctenim vlivu vetru ",
