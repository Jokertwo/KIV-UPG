...
public class Trajektorie {
	...
	public Scanner sc = new Scanner(System.in);
		...
		/**
		 * navraci hodnotu krok
		 * jez se pouziva u pocitani a vytvareni pole
		 * pro spocteni zavylosti rzchlosti na urazene vzdalenosti
		 * 
		...
		/**
		 * vymaze pole dostrelx a dostrely kde jsou ulozeny
		 * informace o dopadu strely pri ruzne rychlosti
		 */
		 ...
		 * 
		 * @param rychlost jako parametr bere rychlost strely
		 * @throws Chyba kontroluje jestli je rzchlost vetsi nez 0
		 */
		 ...
		 * 
		 * @param uhel jako parametr bere azimut strely
		 * @throws Chyba kontroluje jestli je azimut v rozsahu -180 az 180
		 */
		 ...
		 * 
		 * @param elevace jako parametr bere elevaci strely
		 * @throws Chyba kontroluje jestli je elevace mezi 0 az 90
		 */
		...
		/**
		 * pocita a vytvari pole 2 pole, jedno pro x souradnice druhe pro y souradnice
		 * neni zde zapocitan vliv vetru
		 * 
		 */
			public void dostrel(){
				...
				/**vypocteni drahy strely
				se zapoctentm vlivu vetru
				naplnuji se zde 3 pole a to x a y souradnicemi
				a pak pole se z souradnici ktera predstavuje vysku
				*/
			...
			do{
				...
				z0 = z0 + Vz * deltaT;
						...
						Vx = Vx + (0 * (gravitacniZrychleni/meritko) * deltaT) + ((VvitrX/meritko) - Vx) * odporVzduchu * deltaT;
						Vy = Vy + (0 * (gravitacniZrychleni/meritko) * deltaT) + ((VvitrY/meritko) - Vy) * odporVzduchu * deltaT;
						Vz = Vz + (-1 * (gravitacniZrychleni/meritko) * deltaT) + ((VvitrZ/meritko) - Vz)* odporVzduchu * deltaT;
			 ...
			 * @param a predstavuje sloupec matice
			 * @param b predstavuje radek matice 
			 */
			 ...
			 * vraci prvek z pole
			 * 
			 * @param a index na kterem chci ziskat prvek
			...
			/**
			 * zjistuje velikost pole ve kterem jsou uchovavana data
			 * s hodnotami dostrelu pri zadane elevaci a rychlosti
			 * 
