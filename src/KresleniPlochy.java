...
public class KresleniPlochy extends JPanel {
	...
	public KresleniPlochy(int meritko,int velikostDopadu){
	 ...
	 * 
	 * @param a jako parametr bere hodnotu double kterou prevede
	 * @return vraci hodnotu float v rozsahu 0 az 1
	 * 
	 */
	public float barvaStrely(double a){
	 ...
	 * 
	 */
	public BufferedImage kresleniStrely() {
	...
	/**
	 * pokud strela dopadla v mape nakresli dopad
	 * jinak vypise info o tom ze strela vyletela z mapy
	 * 
	 * @param g2 Graphics2D
	 */
	public void dopad(BufferedImage image){
		...
		if(trajekt.kontrolaDopaduVMape()== true){
			...
			g2.setColor(Color.ORANGE);
				...
				g2.fillOval(trajekt.getX0()-(velikostDopadu/2),trajekt.getY0()-(velikostDopadu/2), velikostDopadu, velikostDopadu);
		}
	...
	/**vykresleni smeru vetru sipkou
	 * ktera se meni podle velikosti vetru
	 * a ulozeni do pameti jako BufferedImage
	 * @param g2 Graphics2D
	 */
